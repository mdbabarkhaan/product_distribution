...
class EditOrderBooker extends StatefulWidget {
  String? id;
   EditOrderBooker({this.id,Key? key}) : super(key: key);

  @override
  State<EditOrderBooker> createState() => _EditOrderBookerState();
}

class _EditOrderBookerState extends State<EditOrderBooker> {
  ...
  data() async {
    var doc = await FirebaseReferences().order_bookersReference.doc(widget.id).get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar.appBar(text: "ORDER BOOKER DETAIL",onPressed: () => Get.back(),),
      body: Form(
        key: key,
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              ...
              Space(20),
              ReusbaleRow(value: "Booker Name",iconData: Icons.person,onPress: () {},value1:BookerNameController.text ),
              Space(20),
              ReusbaleRow(value: "Booker Age",iconData: Icons.perm_contact_cal,onPress: () {},value1:BookerAgeController.text ),
              Space(20),
              ReusbaleRow(value: "Phone",iconData: Icons.phone,onPress: () {},value1:PhoneController.text ),
              Space(20),
              ReusbaleRow(value: "CNIC",iconData: Icons.phone_iphone_sharp,onPress: () {},value1:PhoneController.text ),
              Space(20),
  ...
  Future addData() async{
    try{
      FirebaseReferences().order_bookersReference.doc(widget.id).update({
